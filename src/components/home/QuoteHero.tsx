        ...
        <motion.div variants={fadeInUp} className="text-center">
          ...
          <motion.blockquote variants={fadeInUp} className="relative">
            <div className="relative z-10">
              <p className="mx-auto max-w-3xl text-xl font-medium leading-relaxed text-[#dce7f1] md:text-2xl md:leading-relaxed">
          ...
          <motion.div variants={fadeInUp} className="mt-6">
            <p className="bg-gradient-to-r from-[#7cd8ff] to-[#FFC635] bg-clip-text text-lg font-medium text-transparent">Robert Cobb</p>
