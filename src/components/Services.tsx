              ...
              >
                ...
                <div className="relative h-52 overflow-hidden">
                  ...
                  <img
                    ...
                    alt={service.title}
                  />
                  <motion.div variants={fadeInUp} className="absolute right-4 top-4 rounded-full border border-white/10 bg-[rgba(8,19,31,0.82)] p-3 shadow-[0_10px_25px_rgba(0,0,0,0.25)]">
                    <Icon className="h-6 w-6 text-[#4ec4ff]" />
                  </motion.div>
                </div>

                <div className="relative p-6">
                  <motion.h3 variants={fadeInUp} className="mb-2 text-xl font-bold tracking-[-0.02em] text-[#f4fbff] transition-colors duration-300 group-hover:text-[#7cd8ff]">
                    {service.title}
                  </motion.h3>
                  <motion.p variants={fadeInUp} className="text-[15px] leading-7 text-[#9db0c3] sm:text-base">{service.description}</motion.p>
                </div>
